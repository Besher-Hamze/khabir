...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      "location_tracking_has_been_stopped":
          "Location tracking has been stopped",
      "now_tracking_your_service_provider":
          "Now tracking your service provider",
      "your_service_has_been_completed": "Your service has been completed",
      "your_service_has_been_cancelled": "Your service has been cancelled",
      ...
      "location_data_has_been_updated": "Location data has been updated",
      ...
      'error_submitting_service_request': 'Error Submitting Service Request',
      ...
      'please_select_a_service_location': 'Please Select A Service Location',
      'please_select_a_date_for_your_service':
          'Please Select A Date For Your Service',
      'no_location_details': 'No Location Details',
      'service_request_submitted_from_mobile_app':
      ...
      'air_conditioning': 'AC',
      'painting': 'Painting',
      'temporarily_selected_for_this_service':
          "Temporarily selected for this service",
      'premium': 'Premium',
      'gold': 'Gold',
      'silver': 'Silver',
      'bronze': 'Bronze',
      ...
      'street_building_number_apartment_etc':
          'Street, building number, apartment, etc.',
      'description_optional': 'Description (Optional)',
      'additional_notes_about_this_location':
      ...
      'home_work_office': 'Home, Work, Office',
    ...
    'ar': {
      ...
      'online': 'متصل',
      "temporarily_selected_for_this_service": "تم اختياره مؤقتًا لهذه الخدمة",
      ...
      'welcome_to_the_khabir_app': 'مرحباً بك في تطبيق خبير',
      'we_are_happy_to_welcome_you_to_the_khabir_family':
          'نحن سعداء لانضمامك إلى عائلة خبير',
      'failed_to_update_profile': 'فشل تحديث الملف الشخصي',
      'service_request_submitted_successfully': 'تم إرسال الطلب بنجاح',
      'error_submitting_service_request': 'فشل إرسال الطلب',
      'network_connection_error': 'خطأ في الاتصال بالشبكة',
      'invalid_data_format': 'خطأ في التنسيق',
      'request_timed_out': 'انتهت صلاحية الطلب',
      'an_unexpected_error_occurred': 'حدث خطأ غير متوقع',
      'please_select_at_least_one_service': 'يرجى اختيار خدمة واحدة على الأقل',
      'please_select_a_service_location': 'يرجى اختيار موقع الخدمة',
      'please_select_a_date_for_your_service': 'يرجى اختيار تاريخ الخدمة',
      'no_location_details': 'لا توجد تفاصيل الموقع',
      'service_request_submitted_from_mobile_app':
          'تم إرسال الطلب من تطبيق خبير',
      ...
      'error_loading_orders': 'خطأ في جلب الطلبات',
      'error_deleting_order': 'خطأ في حذف الطلب',
      'error_updating_order_status': 'خطأ في تحديث حالة الطلب',
      'error_cancelling_order': 'خطأ في إلغاء الطلب',
      'contact_us': 'تواصل معنا',
      'error_loading_order_details': 'خطأ في جلب تفاصيل الطلب',
      ...
      'tap_to_select_location': 'اضغط لاختيار الموقع',
      'tap_anywhere_on_the_map_or_drag_the_pin_to_select_location':
          'اضغط أو اسحب الدبوس لاختيار الموقع',
      ...
      'street_building_number_apartment_etc': 'الشارع، رقم المبنى، الشقة، etc.',
      'description_optional': 'الوصف (اختياري)',
      'additional_notes_about_this_location':
          'الملاحظات الإضافية عن هذا الموقع',
      ...
      'please_select_a_location_on_the_map': 'يرجى اختيار موقع على الخريطة',
      'description': 'الوصف',
      'state_governorate': 'المحافظة',
      'enter_your_full_name': 'أدخل اسمك الكامل',
      'name_cannot_be_empty': 'اسم المستخدم لا يمكن أن يكون فارغ',
      ...
      "home_work_office": "منزل , مكتب , ...",
      "are_you_sure_you_want_to_delete_your_account_this_action_cannot_be_undone":
          "هل انت متاكد من حذف حسابك ؟ هذا الإجراء لا يمكن التراجع عنه",
      ...
      "nearby": "قريب",
      "almost_there": "قريب جداً",
      "arrived": "وصل",
      "providing_service": "يقدم الخدمة",
      "offline": "غير متصل",
      "busy": "مشغول",
      "tracking_started": "تم تتبع الخدمة",
      "tracking_stopped": "تم إيقاف التتبع",
      "location_tracking_has_been_stopped": "تم إيقاف تتبع الموقع",
      "now_tracking_your_service_provider": "تم تتبع مقدم الخدمة",
      "your_service_has_been_completed": "تم الخدمة",
      "your_service_has_been_cancelled": "تم إلغاء الخدمة",
      "calculating": "جاري الحساب",
      "connecting": "جاري الاتصال",
      "available": "متاح",
      "service_completed": "تم الخدمة",
      "service_cancelled": "تم إلغاء الخدمة",
      "tracking_refreshed": "تم تحديث التتبع",
      "location_data_has_been_updated": "تم تحديث بيانات الموقع",
      // Rating Dialog
      ...
      'camera': 'الكاميرا',
      'gallery': 'المعرض',
      'please_check_your_internet_connection': 'يرجى التحقق من اتصالك',
      'location_selected': 'الموقع المحدد',
      'confirmation': 'تأكيد',
      'enter_6_digit_code': 'أدخل 6 أرقام',
